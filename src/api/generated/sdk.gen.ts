...
/**
 * CancelRun attempts to stop a currently running job.
 */
export const tradeServiceCancelRun = <ThrowOnError extends boolean = false>(options: Options<TradeServiceCancelRunData, ThrowOnError>) => {
    return (options.client ?? client).post<TradeServiceCancelRunResponses, TradeServiceCancelRunErrors, ThrowOnError>({
